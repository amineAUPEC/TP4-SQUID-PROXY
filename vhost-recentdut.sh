...
mkdir -p /var/www/www2.spachnat.com
...
echo  DocumentRoot /var/www/www1.spachnat.com  >> /etc/apache2/sites-available/www1.spachnat.com.conf
...
echo  DocumentRoot /var/www/www2.spachnat.com>> /etc/apache2/sites-available/www2.spachnat.com.conf
...
echo  DocumentRoot /var/www/tendir.com >> /etc/apache2/sites-available/tendir.com.conf
echo \</VirtualHost\> >> /etc/apache2/sites-available/tendir.com.conf

echo coucou lorieforever > /var/www/lorieforever/index.html
...
echo  DocumentRoot /var/www/lorieforever >> /etc/apache2/sites-available/www.lorieforever.fr.conf
...
echo  DocumentRoot /var/www/www.gogleo.fr >> /etc/apache2/sites-available/www.gogleo.fr.conf
...
echo  DocumentRoot /var/www/www.delichoc.fr >> /etc/apache2/sites-available/www.delichoc.fr.conf
...
echo  DocumentRoot /var/www/delichoc-my.shorepaint.com >> /etc/apache2/sites-available/delichoc-my.shorepaint.com.conf
